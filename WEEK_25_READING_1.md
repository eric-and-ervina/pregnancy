...
flowchart TD
    ...
    style A fill:#ff6b6b,color:#fff,stroke:#c0392b,stroke-width:2px
    style B fill:#e74c3c,color:#fff,stroke:#922b21,stroke-width:2px
    style C fill:#e67e22,color:#fff,stroke:#a04000,stroke-width:2px
    style D fill:#f39c12,color:#fff,stroke:#b7950b,stroke-width:2px
    style E fill:#f39c12,color:#fff,stroke:#b7950b,stroke-width:2px
    style F fill:#f39c12,color:#fff,stroke:#b7950b,stroke-width:2px
...
flowchart TD
    ...
    F["📉 OXYTOCIN SUPPRESSED"]
    G["🚫 ENDORPHINS BLOCKED"]
    H["🔥 INCREASED PAIN"]
    I["😰 PAIN CONFIRMS FEAR"]
    ...
    style X1 fill:#27ae60,color:#fff,stroke:#1e8449,stroke-width:2px
    style X2 fill:#27ae60,color:#fff,stroke:#1e8449,stroke-width:2px
    style X3 fill:#27ae60,color:#fff,stroke:#1e8449,stroke-width:2px
